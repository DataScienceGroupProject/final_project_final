...
import 'package:ds_group_project/models/channel_model.dart';
import 'package:ds_group_project/models/video_model.dart';
import 'package:ds_group_project/utilities/keys.dart';

class APIService{
  String playListId;

  APIService(this.playListId);

  // APIService._instantiate(this.playListId);
  //
